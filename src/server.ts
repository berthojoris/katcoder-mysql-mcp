  ...
  private parseConnectionString(connectionString: string): DatabaseConfig {
    try {
      ...
      if (url.protocol !== "mysql:" && url.protocol !== "mysql2:") {
        throw new Error(
          "Invalid connection string protocol. Must be mysql:// or mysql2://",
        );
      }
      ...
      return {
        ...
        connectionLimit: 20, // Increased for AI agent concurrent requests
        acquireTimeout: 120000, // 2 minutes - increased for AI agents
        timeout: 120000, // 2 minutes - increased for AI agents
        connectTimeout: 30000, // 30 seconds for initial connection
        queueLimit: 0, // Unlimited queue to prevent rejections
    ...
    return [
      {
        name: "list",
        description:
          "List tables in the database or columns in a specific table",
        inputSchema: {
          type: "object",
          properties: {
            table: {
            ...
            column: {
              ...
              properties: {
                ...
                type: {
                  type: "string",
                  description:
                    "Column data type (e.g., VARCHAR(255), INT, DATETIME)",
                },
                nullable: {
                  type: "boolean",
        ...
        inputSchema: {
          ...
          properties: {
            ...
            newDefinition: {
              type: "string",
              description:
                "Column definition for the renamed column (optional, defaults to old definition)",
            },
          },
      ...
      },
      {
        ...
        description:
          "Display table data in a formatted, user-friendly way with automatic pagination and column information",
        inputSchema: {
          type: "object",
          properties: {
            table: {
